...
<head>
    ...
    <title>Página no encontrada - Kiosco POS</title>
    ...
    <style>
        ...
        .error-header { background: #4e73df; color: white; padding: 2rem; }
...
<body>
    <div class="card error-card">
        <div class="error-header">
            ...
            <h1 class="error-code mt-2">404</h1>
        </div>
        <div class="error-body">
            <h4 class="fw-bold text-gray-800 mb-3">Página no encontrada</h4>
            <p class="text-muted mb-4 pb-2">Parece que te perdiste. El producto, la venta o la sección que estás buscando no existe o fue eliminada.</p>
